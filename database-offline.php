		...
		<div class="row align-items-start">
			<div class="row">
				...
				<div class="container" style="text-align: center; padding-top: 10%;">
					<a href="set-up-database.php" class="btn btn-primary">Set up/Reset DB</a>
				</div>
				<div class="container" style="text-align: center; padding-top: 5%;">
					<button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal">Error information</button>
				</div>
			</div>
			<div class="col">
				<div class="container"style="text-align: center; padding-top: 1%;">
					<img src="./images/dberror.png" alt="database outline" width="300" height="300">
					<br>
					<form action="database-offline.php"
						...
						<input name="database-offline-php-submit-button" class="btn btn-danger" type="submit" value="Opt Out" />
					</form>
...
<!--
<div>&nbsp;</div>
<div class="jumbotron">The database server at
