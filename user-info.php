...
<div class="jumbotron">User Lookup (SQL)</div>

<?php include_once (__ROOT__.'/includes/back-button.inc');?>
<?php include_once (__ROOT__.'/includes/hints/hints-menu-wrapper.inc'); ?>

<span style="white-space: nowrap; font-weight: bold;">
	<a 	href="./webservices/soap/ws-user-account.php" 
		class="btn btn-success" style="color: #000000;">
		<i class="fa-duotone fa-rotate fa-lg" aria-hidden="true"></i>
...
<span style="white-space: nowrap; font-weight: bold;">
	<a 	href="./webservices/soap/ws-user-account.php" 
		class="btn btn-primary" style="color: #000000;">
		<i class="fa-thin fa-book fa-lg" aria-hidden="true"></i>
